...
public class SecondRegistrationActivity extends AppCompatActivity {
    ...
    private String nickname, districtStr, villageStr, wardStr, categoryStr = null;
    private String mNoStr = "Something";
            ...
            if (TextUtils.isEmpty(nickname) || nickname.equals("")) {
                ...
                if (mAuth.getCurrentUser() != null) {
                    ...
                    if (emailStr.contains("@")) {
                        ...
                        String[] splitStringEmail = emailStr.split("@");

                        // String emailAddressStr = splitStringEmail[1];
                        nickname = splitStringEmail[0];


                    } else Log.i(TAG, "initViews: if (emailStr.contains(\"@\")) { is null");
                } else
                    Log.i(TAG, "initViews: String[] splitStringEmail = emailStr.split(\"@\"); curent user is null");
